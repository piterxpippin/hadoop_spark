...
ssh -o StrictHostKeyChecking=no -i $keyPair ec2-user@$nodeAddress 'if [ -d "~/hadoop_spark" ]; then cd ~/hadoop_spark; git pull -r; else git clone https://github.com/piterxpippin/hadoop_spark.git; done'
